...
/// Inspired by modern productivity apps with teal accent system
class ResponsiveHelper {
  ...
  static const Color purplePrimary = Color(0xFF14B8A6); // Main teal
  static const Color purpleSecondary = Color(0xFF5EEAD4); // Lighter teal
  static const Color purpleAccent = Color(0xFF0F766E); // Darker teal
  static const Color purpleLight = Color(0xFF7DD3FC); // Light teal-blue
