  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((_) async {
      ...
      if (SharedPreferencesUtil().notificationsEnabled) {
        // NotificationService.instance.register(); // Disabled - requires Firebase
        // NotificationService.instance.saveNotificationToken(); // Disabled - requires Firebase
      }
      ...
      // Skip conversation loading - requires API/auth
      // if (mounted) {
...
class _HomePageState extends State<HomePage> with WidgetsBindingObserver, TickerProviderStateMixin {
  ...
  void _listenToMessagesFromNotification() {
    // Skip notification listener - NotificationService disabled
                ...
                child: GestureDetector(
                  ...
                  child: Stack(
                    children: [
                      Column(
                        children: [
                          // Remove subscription features - OutOfCreditsWidget disabled
                          ...
                          if (home.isChatFieldFocused ||
                            ...
                            return Stack(
                              children: [
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: InkWell(
                                            onTap: () {
                                              HapticFeedback.mediumImpact();
                                              MixpanelManager().bottomNavigationTabClicked('Journal');
                                              primaryFocus?.unfocus();
                                        ...
                                        // Center space removed - record button moved to app bar
                                        // Memories tab
                                        Expanded(
                                          child: InkWell(
                                            onTap: () {
                                ...
                                // Central Record Button removed - moved to app bar header
        ...
        children: [
          ...
          Row(
            children: [
              ...
              // Chat Button - Always show "Ask" button in top bar
              GestureDetector(
                onTap: () {
                  HapticFeedback.mediumImpact();
